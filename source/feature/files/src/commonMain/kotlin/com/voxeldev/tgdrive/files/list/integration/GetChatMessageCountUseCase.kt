 ...
 * @author nvoxel
 */
internal class GetChatMessageCountUseCase : BaseUseCase<Long, Int>(), KoinComponent {

    private val chatsRepository: ChatsRepository by inject()

    override suspend fun run(params: Long): Int = chatsRepository.getChatMessageCount(chatId = params)
}
