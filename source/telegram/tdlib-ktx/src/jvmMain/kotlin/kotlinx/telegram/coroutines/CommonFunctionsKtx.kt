...
import org.drinkless.tdlib.TdApi.InputBusinessIntro
 ...
 */
suspend fun TelegramFlow.assignAppStoreTransaction(
    receipt: ByteArray?,
...
suspend fun TelegramFlow.assignGooglePlayTransaction(
    ...
    TdApi.AssignGooglePlayTransaction(
        packageName, storeProductId,
 ...
 */
suspend fun TelegramFlow.launchPrepaidPremiumGiveaway(
    giveawayId: Long,
...
): FoundPositions = this.sendFunctionAsync(
    TdApi.SearchStringsByPrefix(
        strings, query, limit,
...
/**
 * Suspend function, which changes the business intro of the current user. Requires Telegram
 * Business subscription.
 *
 * @param intro The new intro of the business; pass null to remove the intro.
 */
suspend fun TelegramFlow.setBusinessIntro(intro: InputBusinessIntro?) =
    this.sendFunctionLaunch(TdApi.SetBusinessIntro(intro))
...
suspend fun TelegramFlow.setTdlibParameters(
    ...
    TdApi.SetTdlibParameters(
        useTestDc, databaseDirectory, filesDirectory,
...
suspend fun TelegramFlow.toggleBotIsAddedToAttachmentMenu(
    ...
    TdApi.ToggleBotIsAddedToAttachmentMenu(
        botUserId, isAdded,
        allowWriteAccess
    )
)
