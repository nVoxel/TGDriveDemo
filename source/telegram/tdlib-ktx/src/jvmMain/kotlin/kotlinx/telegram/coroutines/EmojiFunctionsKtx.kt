...
): Emojis = this.sendFunctionAsync(
    TdApi.GetAllStickerEmojis(
        stickerType, query, chatId,
        returnOnlyMainEmoji
    )
)
 ...
 * be empty if unknown.
 *
 * @return [EmojiKeywords] Represents a list of emoji with their keywords.
 */
...
/**
 * Suspend function, which changes the list of emoji corresponding to a sticker. The sticker must
 ...
 */
suspend fun TelegramFlow.setSupergroupCustomEmojiStickerSet(
    supergroupId: Long,
    customEmojiStickerSetId: Long,
) =
    this.sendFunctionLaunch(
        TdApi.SetSupergroupCustomEmojiStickerSet(
            supergroupId,
