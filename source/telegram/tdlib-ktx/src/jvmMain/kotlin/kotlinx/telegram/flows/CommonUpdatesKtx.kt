 ...
 */
fun TelegramFlow.authorizationStateFlow(updateAuthorizationStateMapper: UpdateAuthorizationStateMapper): Flow<AuthenticationState> =
    this.getUpdatesFlowOfType<TdApi.UpdateAuthorizationState>()
        .mapNotNull { updateAuthorizationStateMapper.toResponse(authorizationState = it.authorizationState) }
