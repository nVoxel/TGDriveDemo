...
interface UserKtx : BaseKtx {
     ...
     */
    suspend fun User.canSendMessageTo(onlyLocal: Boolean) = api.canSendMessageToUser(
        this.id,
        onlyLocal
    )
     ...
     */
    suspend fun User.setMenuButton(menuButton: BotMenuButton?) = api.setMenuButton(
        this.id,
        menuButton
    )
     ...
     * @return [TdApi.UserSupportInfo] Contains custom information about the user.
     */
    suspend fun User.setSupportInfo(message: FormattedText?) = api.setUserSupportInfo(
        this.id,
        message
    )
