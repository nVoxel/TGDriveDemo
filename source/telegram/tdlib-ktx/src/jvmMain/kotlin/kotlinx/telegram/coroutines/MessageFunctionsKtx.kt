...
suspend fun TelegramFlow.addMessageReaction(
    ...
    TdApi.AddMessageReaction(
        chatId, messageId, reactionType, isBig,
...
suspend fun TelegramFlow.forwardMessages(
    ...
    TdApi.ForwardMessages(
        chatId, messageThreadId, fromChatId,
...
suspend fun TelegramFlow.getMessageAddedReactions(
    ...
    offset: String?,
    limit: Int,
): AddedReactions = this.sendFunctionAsync(
    TdApi.GetMessageAddedReactions(
        chatId, messageId,
...
suspend fun TelegramFlow.getMessageAvailableReactions(
    ...
    messageId: Long,
    rowSize: Int,
): AvailableReactions = this.sendFunctionAsync(
...
suspend fun TelegramFlow.getMessagePublicForwards(
    ...
    offset: String?,
    limit: Int,
): PublicForwards = this.sendFunctionAsync(
...
suspend fun TelegramFlow.getSavedMessagesTopicHistory(
    ...
    TdApi.GetSavedMessagesTopicHistory(
...
suspend fun TelegramFlow.searchSavedMessages(
    ...
    TdApi.SearchSavedMessages(
        savedMessagesTopicId, tag,
...
suspend fun TelegramFlow.sendBusinessMessage(
    ...
    replyMarkup: ReplyMarkup?,
    inputMessageContent: InputMessageContent?,
): BusinessMessage = this.sendFunctionAsync(
    TdApi.SendBusinessMessage(
        businessConnectionId, chatId,
        replyTo, disableNotification, protectContent, replyMarkup, inputMessageContent
    )
)
...
): BusinessMessages = this.sendFunctionAsync(
    TdApi.SendBusinessMessageAlbum(
        businessConnectionId,
        chatId, replyTo, disableNotification, protectContent, inputMessageContents
    )
)
...
suspend fun TelegramFlow.sendMessage(
    ...
    TdApi.SendMessage(
        chatId, messageThreadId, replyTo, options,
...
suspend fun TelegramFlow.sendQuickReplyShortcutMessages(
    ...
    TdApi.SendQuickReplyShortcutMessages(
        chatId, shortcutId,
        sendingId
    )
)
 ...
 */
suspend fun TelegramFlow.toggleSavedMessagesTopicIsPinned(
    savedMessagesTopicId: Long,
    isPinned: Boolean,
) =
 ...
 */
suspend fun TelegramFlow.toggleSupergroupJoinToSendMessages(
    supergroupId: Long,
...
): FormattedText = this.sendFunctionAsync(
    TdApi.TranslateMessageText(
        chatId, messageId,
        toLanguageCode
    )
)
