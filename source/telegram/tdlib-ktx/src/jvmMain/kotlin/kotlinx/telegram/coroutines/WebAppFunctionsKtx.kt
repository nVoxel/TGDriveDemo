...
): HttpUrl = this.sendFunctionAsync(
    TdApi.GetWebAppLinkUrl(
        chatId, botUserId, webAppShortName,
...
): WebAppInfo = this.sendFunctionAsync(
    TdApi.OpenWebApp(
        chatId, botUserId, url, theme,
...
suspend fun TelegramFlow.sendWebAppCustomRequest(
    ...
    method: String?,
    parameters: String?,
): CustomRequestResult = this.sendFunctionAsync(
