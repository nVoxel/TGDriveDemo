...
class TelegramFlow(
...
) : CommonTelegramFlow, KoinComponent {
     ...
     */
    suspend inline fun <reified ExpectedResult : TdApi.Object> sendFunctionAsync(function: TdApi.Function<ExpectedResult>): ExpectedResult =
    ...
    override fun restartClient() = attachClient(restartClient = true)
