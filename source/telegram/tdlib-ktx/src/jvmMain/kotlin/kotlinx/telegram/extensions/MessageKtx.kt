...
interface MessageKtx : BaseKtx {
     ...
     */
    suspend fun Message.clickChatSponsored(chatId: Long) = api.clickChatSponsoredMessage(
        chatId,
        this.id
    )
     ...
     */
    suspend fun Message.getPremiumGiveawayInfo(chatId: Long) = api.getPremiumGiveawayInfo(
        chatId,
        this.id
    )
