...
suspend fun TelegramFlow.canSendMessageToUser(userId: Long, onlyLocal: Boolean):
        CanSendMessageToUserResult = this.sendFunctionAsync(
    TdApi.CanSendMessageToUser(
        userId,
        onlyLocal
    )
)
 ...
 * specified.
 */
suspend fun TelegramFlow.reorderSupergroupActiveUsernames(
    supergroupId: Long,
...
suspend fun TelegramFlow.shareUsersWithBot(
    ...
    TdApi.ShareUsersWithBot(
        chatId, messageId, buttonId, sharedUserIds,
        onlyCheck
    )
)
...
suspend fun TelegramFlow.toggleSupergroupUsernameIsActive(
    ...
    TdApi.ToggleSupergroupUsernameIsActive(
        supergroupId, username,
        isActive
    )
)
