...
import kotlinx.telegram.coroutines.toggleStoryIsPinned
...
interface StoryKtx : BaseKtx {
    ...
    suspend fun Story.getChatInteractions(
        ...
        offset: String?,
        limit: Int,
    ) = api.getChatStoryInteractions(
        storySenderChatId, this.id, reactionType, preferForwards, offset,
        limit
    )
    ...
    suspend fun Story.getInteractions(
        ...
        offset: String?,
        limit: Int,
    ) = api.getStoryInteractions(
        this.id, query, onlyContacts, preferForwards, preferWithReaction,
        offset, limit
    )
     ...
     */
    suspend fun Story.getStatistics(chatId: Long, isDark: Boolean) = api.getStoryStatistics(
        chatId,
        this.id, isDark
    )
     ...
     * private.
     */
    suspend fun Story.toggleIsPinned(storySenderChatId: Long, isPinned: Boolean) =
        api.toggleStoryIsPinned(storySenderChatId, this.id, isPinned)
}
