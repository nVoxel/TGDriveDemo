 ...
 */
interface TelegramKtx : BasicGroupKtx, CallKtx, ChatKtx,
    FileKtx, GroupCallKtx, MessageKtx,
    NotificationGroupKtx, ProxyKtx, SecretChatKtx,
    SessionKtx, SupergroupKtx, UserKtx,
    CommonKtx {
    /**
