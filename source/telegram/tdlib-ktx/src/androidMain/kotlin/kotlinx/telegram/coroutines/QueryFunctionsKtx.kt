...
suspend fun TelegramFlow.answerCallbackQuery(
    ...
    TdApi.AnswerCallbackQuery(
        callbackQueryId, text, showAlert, url,
        cacheTime
    )
)
...
suspend fun TelegramFlow.answerInlineQuery(
    ...
    TdApi.AnswerInlineQuery(
        inlineQueryId, isPersonal, results, cacheTime,
...
suspend fun TelegramFlow.answerShippingQuery(
    ...
    TdApi.AnswerShippingQuery(
        shippingQueryId, shippingOptions,
        errorMessage
    )
)
...
): CallbackQueryAnswer = this.sendFunctionAsync(
...
suspend fun TelegramFlow.getInlineQueryResults(
    ...
    query: String?,
    offset: String?,
): InlineQueryResults = this.sendFunctionAsync(
