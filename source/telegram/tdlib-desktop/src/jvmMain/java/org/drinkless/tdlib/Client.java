...
public final class Client {
    static {
        try {
            System.load("/path/to/lib/libtdjni.dylib");
    ...
    public interface ResultHandler {
         ...
         *
         * @param object Result of query or update of type Update about new events.
         */
    ...
    /**
     * Exception class thrown when TDLib error occurred while performing Function.
     */
    public static class ExecutionException extends Exception {
        ...
        /**
         * @param error TDLib error occurred while performing Function.
         */
     ...
     *                         of the query or with Error as parameter. If it is null, nothing
     *                         will be called.
     ...
     * @param query         Object representing a query to the TDLib.
     * @param resultHandler Result handler with onResult method which will be called with result
     *                      of the query or with Error as parameter. If it is null, then
     *                      defaultExceptionHandler will be called.
     */
    public void send(Function query, ResultHandler resultHandler) {
    ...
    public static <T extends TdApi.Object> T execute(Function query) throws ExecutionException {
    ...
    private static class ResponseReceiver implements Runnable {
        ...
        private void processResult(int clientId, long id, TdApi.Object object) {
            ...
            if (id == 0 && object instanceof UpdateAuthorizationState) {
                AuthorizationState authorizationState = ((UpdateAuthorizationState) object).authorizationState;
                if (authorizationState instanceof AuthorizationStateClosed) {
                    isClosed = true;
                }
            }
    ...
    private Client(ResultHandler updateHandler, ExceptionHandler updateExceptionHandler, ExceptionHandler defaultExceptionHandler) {
        ...
        send(new GetOption("version"), null, null);
    }
